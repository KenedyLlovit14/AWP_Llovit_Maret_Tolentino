...
<div class="row">
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-light shadow">
            ...
            <span class="info-box-number text-right">
                <?php 
                    echo $conn->query("SELECT * FROM `registration_list`")->num_rows;
                ?>
            </span>
            </div>
            <!-- /.info-box-content -->
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-light shadow">
            ...
            <span class="info-box-number text-right">
                <?php 
                    echo $conn->query("SELECT * FROM `registration_list` where `status` = 0")->num_rows;
                ?>
            </span>
            </div>
            <!-- /.info-box-content -->
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-light shadow">
            ...
            <span class="info-box-number text-right">
                <?php 
                    echo $conn->query("SELECT * FROM `registration_list` where `status` = 2")->num_rows;
                ?>
            </span>
            </div>
            <!-- /.info-box-content -->
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-light shadow">
            ...
            <span class="info-box-number text-right">
                <?php 
                    echo $conn->query("SELECT * FROM `registration_list` where `status` = 1")->num_rows;
                ?>
            </span>
            </div>
            <!-- /.info-box-content -->
